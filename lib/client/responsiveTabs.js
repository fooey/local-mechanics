...
function initTabs(fnCallback){
	...
	$tabs.not('.all').addClass('disabled');
...
function onTabClick(e) {
	...
	async.auto({
		...
		'setActiveTab': ['hide', setActiveTab.bind(null, $tabAnchor)],
		'smartResponsive': ['hide', smartResponsive.bind(null, $toShow.length)],
		'toggleItems': ['smartResponsive', toggleItems.bind(null, $toShow)],
...
function setActiveTab($tabAnchor, fnCallback){
	// console.log('responsiveTabs:setActiveTab');
